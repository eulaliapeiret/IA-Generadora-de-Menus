...
(= (preu crema-zanahoria) 2.50)
(= (preu gazpacho)        2.00)
(= (preu ensalada-cesar)  3.50)
(= (preu sopa-minestrone) 3.00)
(= (preu salmorejo)       2.20)
(= (preu ensalada-pasta)  2.80)
(= (preu pisto)           3.10)

;; preus de los segundos
(= (preu paella-seg)       15.00)
(= (preu arroz-negro)      5.20)
(= (preu pollo-asado)      4.50)
(= (preu pescado-horno)    5.30)
(= (preu fabada-asturiana) 4.80)
(= (preu tortilla-patatas) 23.00)
(= (preu filete-ternera)   6.00)
